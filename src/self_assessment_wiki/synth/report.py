...
Run at the end of `synth.build extract` / `compose`, or on its own:

    python -m self_assessment_wiki.synth.report
"""
...
def render() -> str:
    ...
    lines = [
        ...
        "# Wiki status",
        "",
        "Generated by `python -m self_assessment_wiki.synth.report` - **do not hand-edit**. It "
